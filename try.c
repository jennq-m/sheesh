...
//         if (currentToken.type == NUM || currentToken.type == VIBE || currentToken.type == DRIFT || 
//             currentToken.type == TEXT || currentToken.type == SHORT || currentToken.type == LONG || currentToken.type == LEGIT) {
//             stmt = parseDecStmt();  // Parse a declaration statement
//         } 
//         // Check for iterative statements
//         else if (currentToken.type == REP || currentToken.type == MEANWHILE || currentToken.type == DO) {
//             stmt = parseIterativeStmt();  // Parse an iterative statement
//         } 
//         // Check for input or output statements
//         else if (strcmp(currentToken.value, "input") == 0) {
//             stmt = parseInputStmt();  // Parse an input statement
//         } else if (strcmp(currentToken.value, "out") == 0) {
//             stmt = parseOutputStmt();  // Parse an output statement
//         } 
//         // Handle generic expression statements
//         else {
//             stmt = parseExprStmt();  // Parse a generic statement
//         }

//         // Chain the parsed statement
//         if (!node) {
...
// }
// ASTNode* parseInputStmt() {
//     printf("Parsing <input_stmt>\n");
//     ASTNode *node = newNode("<input_stmt>");

//     if (strcmp(currentToken.value, "input") == 0) {
//         ASTNode *inputNode = newNode("input"); // Terminal symbol: "input"
//         node->left = inputNode;
//         nextToken(); // Consume "input"

//         if (currentToken.type == DELIM_O_PAREN) {
//             ASTNode *openParen = newNode("("); // Terminal symbol: "("
//             inputNode->right = openParen;
//             nextToken(); // Consume '('

//             openParen->right = parseInput(); // Parse <input>

//             if (currentToken.type == DELIM_C_PAREN) {
//                 ASTNode *closeParen = newNode(")"); // Terminal symbol: ")"
//                 openParen->right->right = closeParen;
//                 nextToken(); // Consume ')'

//                 if (currentToken.type == DELIM_SEMCOL) {
//                     ASTNode *semicolon = newNode(";"); // Terminal symbol: ";"
//                     closeParen->right = semicolon;
//                     nextToken(); // Consume ';'
//                     return node;
//                 } else {
//                     printf("Syntax error: Missing semicolon after <input_stmt>\n");
//                     exit(1);
//                 }
//             } else {
//                 printf("Syntax error: Missing closing parenthesis in <input_stmt>\n");
//                 exit(1);
//             }
//         } else {
//             printf("Syntax error: Missing opening parenthesis in <input_stmt>\n");
//             exit(1);
//         }
//     } else {
//         printf("Syntax error: Expected 'input' keyword in <input_stmt>\n");
//         exit(1);
//     }
// }
...
//         node->left = newNode(currentToken.value); // Terminal symbol: CONSTANT_TXTFS
//         nextToken(); // Consume CONSTANT_TXTFS

//         ASTNode *current = node;
//         while (currentToken.type == DELIM_COMMA) {
//             ASTNode *commaNode = newNode(","); // Terminal symbol: ","
//             current->right = commaNode;
//             nextToken(); // Consume ','

//             if (strcmp(currentToken.value, "&") == 0) {
//                 ASTNode *ampersandNode = newNode("&"); // Terminal symbol: "&"
//                 commaNode->left = ampersandNode;
//                 nextToken(); // Consume '&'

//                 if (currentToken.type == IDENTIFIER) {
//                     ASTNode *idNode = newNode(currentToken.value); // Terminal symbol: identifier
//                     ampersandNode->right = idNode;
//                     nextToken(); // Consume identifier
//                 } else {
...
//             current = commaNode; // Move to next argument
//         }

//         return node;
//     } else {
//         printf("Syntax error: Expected CONSTANT_TXTFS in <input>\n");
//         exit(1);
//     }
// }

// ASTNode* parseOutputStmt() {
//     printf("Parsing <output_stmt>\n");
//     ASTNode *node = newNode("<output_stmt>");

//     if (strcmp(currentToken.value, "out") == 0) {
//         ASTNode *outNode = newNode("out"); // Terminal symbol: "out"
//         node->left = outNode;
...
//             openParen->right = parseOutput(); // Parse <output>
...
//                     return node;
//                 } else {
//                     printf("Syntax error: Missing semicolon after <output_stmt>\n");
//                     exit(1);
//                 }
//             } else {
//                 printf("Syntax error: Missing closing parenthesis in <output_stmt>\n");
//                 exit(1);
//             }
//         } else {
//             printf("Syntax error: Missing opening parenthesis in <output_stmt>\n");
//             exit(1);
//         }
//     } else {
//         printf("Syntax error: Expected 'out' keyword in <output_stmt>\n");
//         exit(1);
//     }
// }
...
//         ASTNode *constantNode = newNode(currentToken.value); // Terminal symbol: CONSTANT_TEXT or CONSTANT_TXTFS
//         node->left = constantNode;
//         nextToken(); // Consume text or format specifier
...
//             ASTNode *exprNode = parseExpr(); // Parse expression
//             commaNode->left = exprNode;
...
//         return node;
//     } else {
//         printf("Syntax error: Expected CONSTANT_TEXT or CONSTANT_TXTFS in <output>\n");
//         exit(1);
//     }
// }
